...
export default function NavigationBar() {
    return (
        <footer className='mt-auto'>
            <section className="flex flex-col gap-5 text-xl sm:text-3xl text-center items-center justify-center bg-gradient-to-b from-primary/0 to-primary/30 font-bold py-10 px-4">
