    ...
    <section className="about-container">
      ...
      <div className="flex flex-col text-center gap-5 about-content max-w-4xl mx-auto px-5 sm:px-8 lg:px-16 py-10 sm:text-lg">
        ...
        <p className='text-white/80'>
          Welcome to <strong>Pixel Sanctuary</strong>! We’re a passionate team of developers, gamers, and creators
          dedicated to shaping the future of gaming through cutting-edge software development. Whether you're a seasoned 
        ...
        <p className='text-white/80'>
          We’re not just a team; we’re a movement. We invite you to become one of the <strong>Pixelers</strong> and help us 
          shape the future of gaming. Whether you’re a developer, gamer, or a visionary, Pixel Sanctuary is your home.
        </p>
